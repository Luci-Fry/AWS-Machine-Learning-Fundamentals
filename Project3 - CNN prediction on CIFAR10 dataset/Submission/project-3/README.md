...
Welcome to the Convolutional Neural Networks (CNN) project! This project will give you the opportunity to practice building and training Convolutional Neural Networks from scratch as well as implementing transfer learning to build robust CNNs!
